...
class SntpClient
{
    ...
    public boolean requestTime(String host, int timeout) {
        ...
        try {
            ...
            if (false) CFLog.d("NTPClient request time failed: " + e);
            return false;
        } finally {
            if (socket != null) {
                socket.close();
     ...
     *
     * @return the estimate of the current time, relative to the time value computed from NTP server response.
     */
    public long getNtpTime() {
        return mNtpTime - mNtpTimeReference + SystemClock.elapsedRealtime();
    }
