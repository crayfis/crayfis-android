...
//        if (_mViewPager.getCurrentItem()==ViewPagerAdapter.INACTIVE)
	...
	private void setUpAndConfigureCamera() {
        ...
        try {
            ...
            mParams = param;
            mBitsPerPix = ImageFormat.getBitsPerPixel(mParams.getPreviewFormat());
    ...
    public void onPreviewFrame(byte[] bytes, Camera camera) {
        ...
        try {
            ...
            RawCameraFrame frame = new RawCameraFrame(bytes, acq_time, camera, previewSize.width, previewSize.height, mBitsPerPix);
